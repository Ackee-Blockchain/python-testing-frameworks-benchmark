...
import brownie
import pytest
from brownie import TickMathTest, accounts

import utils
from brownie_tests.snapshots import match_snapshot
from utils import MAX_SQRT_RATIO, MIN_SQRT_RATIO
...
def tick_math():
    return TickMathTest.deploy({"from": accounts[0]})
